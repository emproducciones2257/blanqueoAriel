...
<html>
    ...
    <body>
        ...
        <form action="Servlet">
            ...
            <input name="nroExpe" type="text" class="formulario_" placeholder="Expediente número.."

                   <p class="datos">Carátula:</p>
            <input name="cara" type="text" class="formulario_" placeholder="carátula..">
                <p class="datos">Fuero:</p>
            <select name="fuero" name="fuero" class="formulario_"><br>
                ...
                <input name="nroJuz" type="number" class="formulario_" placeholder="juzgado número..">

            <p class="datos">Fecha de última actualización:</p> 
            <input value="fecha" type="date" class="formulario_" placeholder="actualización.."> <br>
            <input class="btn-dark p-lg-2 mx-1 ms-5" type="submit" name="ac" value="Guardar">
            </button> <button class="btn-dark p-lg-2 ms-1" onclick="">Volver a la lista</button>
        </form>
    </body>
